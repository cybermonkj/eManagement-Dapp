<template>
  ...
  >
    ...
    >
      ...
      <v-card-text  class="white--text grey darken-4 copy" >
        {{ new Date().getFullYear() }} — <strong>E-management dapp © Copyright All rights reserved</strong>
...
import { mdiAccountBoxOutline } from "@mdi/js";
  export default {
    data: () => ({
        accountIcon: mdiAccountBoxOutline,
      icons: [
        'fab fa-facebook',
        'fab fa-twitter',
        'fab fa-google-plus',
